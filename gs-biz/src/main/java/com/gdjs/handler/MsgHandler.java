package com.gdjs.handler;


import com.gdjs.builder.TextBuilder;
import com.gdjs.common.utils.JsonUtils;
            ...
            switch (msgType) {
                case XmlMsgType.TEXT:
                    if (StringUtils.startsWithAny(content, "你好", "在线客服")
                        ...
                        item.setPicUrl("https://gdjs-wxmall.oss-cn-beijing.aliyuncs.com/upload/pwm/logo.png");
                        ...
                        WxMpXmlOutNewsMessage.Item item = new WxMpXmlOutNewsMessage.Item();
                        item.setTitle("gdjs-wechat-mall开发文档1.0.4.pdf");
                        item.setPicUrl("https://gdjs-wxmall.oss-cn-beijing.aliyuncs.com/upload/pwm/logo.png");
