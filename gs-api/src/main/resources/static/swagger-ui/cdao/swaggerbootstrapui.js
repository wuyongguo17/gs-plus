...
(function ($) {
    ...
    var SwaggerBootstrapUi = function (options) {
        ...
        this.titleOfUrl = "http://www.k-banker.cn";
        this.load = 1;
        //tabid
        this.tabId = "tabUl";
        ...
        btnRequest.on("click", function (e) {
            ...
            paramBody.find("tr").each(function () {
                ...
                if (cked) {
                    ...
                    if (trdata["in"] == "body") {
                        //直接判断那类型
                        if (trdata.in == "formData" && trdata.type == "file") {
        ...
        if (apiInfo != null) {
            ...
            if (apiInfo.hasOwnProperty("parameters")) {
                ...
                $.each(pameters, function (i, m) {
                    ...
                    if (m.hasOwnProperty("x-examples")) {
                        minfo.txtValue = m["x-examples"];
                    }
    ...
    SwaggerBootstrapUi.prototype.validateJSR303 = function (parameter, origin) {
        var max = origin["maximum"], min = origin["minimum"], emin = origin["exclusiveMinimum"],
