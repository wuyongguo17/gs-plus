...
import com.gdjs.modules.swaggerbootstrapui.annotations.EnableSwaggerBootstrapUI;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("GDJS")
                .description("GDJSAPP接口文档")
                .version("1.0.0")
                .contact(new Contact("GDJS", "http://www.k-banker.cn/my/u/1", "gdjs@k-banker.cn"))
                .build();
    }
